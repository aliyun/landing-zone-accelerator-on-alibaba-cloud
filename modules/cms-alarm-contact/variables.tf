variable "alarm_contacts" {
  ...
  validation {
    ...
    error_message = "Each alarm_contact.name must start with Chinese or English characters, be 2-40 characters long, and contain only Chinese characters, English letters, numbers, dots, underscores, and hyphens."
  }
  ...
  validation {
    ...
    error_message = "Each alarm_contact.description cannot be empty."
  }
  ...
  validation {
    ...
    error_message = "Each alarm_contact.channels_mail must be a valid email format."
  }
  ...
  validation {
    ...
    error_message = "Each alarm_contact.channels_sms must be a valid Chinese phone number (11 digits or 86- followed by 11 digits)."
  }

  validation {
    condition = alltrue([
      for contact in var.alarm_contacts :
      contact.lang == null || try(contains(["en", "zh-cn"], contact.lang), false)
    ])
    error_message = "Each alarm_contact.lang must be 'en' or 'zh-cn'."
  }
...
variable "alarm_contact_groups" {
  ...
  validation {
    ...
    error_message = "Each alarm_contact_group.name must start with Chinese or English characters, be 2-40 characters long, and contain only Chinese characters, English letters, numbers, dots, underscores, and hyphens."
  }
  ...
  validation {
    ...
    error_message = "Each alarm_contact_group.contacts entry cannot be empty."
  }
